...
export default function PetProfile(props) {
  ...
  const buttonThreeSixFiveZeroTwoSixNineSevenOnClick = useDataStoreDeleteAction(
  ...
  return (
    <Flex
      ...
      backgroundColor="rgba(181,224,255,1)"
    ...
    >
      <Button
        ...
        children="Delete"
        onClick={() => {
          buttonThreeSixFiveZeroTwoSixNineSevenOnClick();
        }}
        {...getOverrideProps(overrides, "Button36502697")}
      ></Button>
      <Image
        width="147px"
        height="142px"
